    ...
    salvarVaga() {
      ...
      if(this.validaFormulario()){
        ...
        this.emitter.emit('alerta', {
          ...
          descricao: 'Parabéns, a vaga foi cadastrada e poderá ser consultada por milhares de profissionais na nossa plataforma.'
        }); //Além de emitir um evento de alerta, está passando um objeto como parâmetro
